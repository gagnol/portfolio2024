    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <video autoPlay={true} muted={true} loop={true}
          className="absolute right-0 z-[-1] xl:bottom-[0px] md:bottom-[-140px]
           sm:bottom-[-190px] overflow-hidden h-[700px]">
          <source 
          src="https://cdn.clickworker.com/wp-content/uploads/2022/06/aiStartpageHeading-test.mp4"
          type="video/mp4"
           />
        </video>
        </div>
